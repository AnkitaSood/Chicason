...
export class DataService {
  ...
  fetchDogBreedImage(breedId) {
    return this.http.get('https://api.thedogapi.com/v1/images/search?breed_ids=' + breedId + '&limit=1', {headers: {'x-api-key': this.dogAPIkey}});
  }
  ...
  fetchCatBreedImage(breedId) {
    return this.http.get('https://api.thecatapi.com/v1/images/search?breed_ids=' + breedId + '&limit=1', {headers: {'x-api-key': this.catAPIKey}});
  }
}
